...
describe Group, type: :model do
 ...
 it 'is not a valid group unless its name is unique' do
 	Group.create(name: "Team Boom", description: "Everything is awesome", user_id: user1.id)
	group2 = Group.new(name: "Team Boom", description: "Everything is awesome", user_id: user2.id)
