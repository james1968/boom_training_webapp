...
RSpec.describe TrainingSessionsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all training_sessions as @training_sessions" do
      training_session = TrainingSession.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:training_sessions)).to eq([training_session])
    end
  end

  describe "GET #show" do
    it "assigns the requested training_session as @training_session" do
      training_session = TrainingSession.create! valid_attributes
      get :show, params: {id: training_session.to_param}, session: valid_session
      expect(assigns(:training_session)).to eq(training_session)
    end
  end

  describe "GET #new" do
    it "assigns a new training_session as @training_session" do
      get :new, params: {}, session: valid_session
      expect(assigns(:training_session)).to be_a_new(TrainingSession)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created training_session as @training_session" do
        post :create, params: {training_session: valid_attributes}, session: valid_session
        expect(assigns(:training_session)).to be_a(TrainingSession)
        expect(assigns(:training_session)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved training_session as @training_session" do
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the training_session as @training_session" do
        training_session = TrainingSession.create! valid_attributes
